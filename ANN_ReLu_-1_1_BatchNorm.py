...
X_train = np.subtract(X_train/255, 1)
X_test =  np.subtract(X_test/255 , 1)
...
history = model.fit(X_train,y_train,batch_size=128,epochs=50,validation_data=(X_test,y_test),verbose=1,shuffle=True)
